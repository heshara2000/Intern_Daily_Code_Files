...
groq_api_key = os.getenv("GROQ_API_KEY", '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')  # Groq API key
os.environ["TAVILY_API_KEY"] = os.getenv("TAVILY_API_KEY", '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')  # Set Tavily API key
